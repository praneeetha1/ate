...
begin
  -- username intentionally left NULL so UsernameModal prompts the user to choose one.
  -- Inserting raw full_name / email prefix would violate the username_format constraint
  -- for any name containing spaces, capitals, or periods.
